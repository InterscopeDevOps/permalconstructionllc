...
function FooterOne() {
  ...
  return (
    <>
      <div className="w-full flex justify-center bg-gray-400 bg-opacity-5 p-3 py-14 backgrounFooter text-white">
                  ...
                  <li className="py-2 flex flex-col">
                    ...
                    </span>
                    {
                      rpdata?.tiposPago?.[0]?.activo ?
                        <img src={rpdata?.tiposPago?.[0]?.img} width={'100'} alt='no found' />
                        : null
                    }
                  </li>
                }
