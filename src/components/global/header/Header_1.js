        ...
        <div>
            ...
            </div>
            {
                rpdata?.simpleWidgets?.[3]?.activo ?
                    <div className='absolute right-[5%] left-[5%] pt-10  flex justify-center items-center'>
                        {/* logo */}
                    ...
                    :
                    <div className='absolute right-[5%] left-[5%] z-10 pt-3  flex justify-between items-center'>
                        {/* logo */}
                        <div className='w-[70%] md:w-[20%] pr-3 md:pr-0'>
                            <Link to={'/'}>
                                <img
