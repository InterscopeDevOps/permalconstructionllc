...
const HeaderSeven = () => {
    ...
    return (
        <header className='w-full flex justify-center bg-footer absolute top-0 z-50'>
                ...
                <div className="md:w-full w-[20%] flex flex-col">
                    ...
                    </p>
                    {
                        rpdata?.simpleWidgets?.[3]?.activo ?
                            null
                            :
                            <div className='md:px-3 px-0 md:py-4 py-0 rounded-sm bg2 rounded-l-[30px] flex my-auto'>
